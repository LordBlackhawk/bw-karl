...
{
    BWMapModifier map("bwapi-data/maps/in.scx");

    for(int x=-10;x<10;x++)
    {
        map.addUnit(BWAPI::UnitTypes::Terran_Marine,BWAPI::Position(32*64 + 32*x,320),0);
        map.addUnit(BWAPI::UnitTypes::Zerg_Zergling,BWAPI::Position(32*64 + 32*x,320+32),0);
        map.addUnit(BWAPI::UnitTypes::Zerg_Zergling,BWAPI::Position(32*64 + 32*x,320+128),1);
        map.addUnit(BWAPI::UnitTypes::Terran_Marine,BWAPI::Position(32*64 + 32*x,320+128+32),1);
    }
